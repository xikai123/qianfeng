$(function(){
	new  Slideshow({
		boxId:"#wrapID",
		imgs:["images/l1.jpg","images/l2.jpg","images/l3.jpg","images/l4.jpg","images/l5.jpg"],
		width:1280,
		height:680,
		timeSpace:3000,
		fadeInOutTime:1000,
...
//属性：
	...
	this.boxId=obj.boxId;	console.log(this.boxId)
	//图片数组
...
Slideshow.prototype.initUI = function(){
	...
	//2、所有按钮的创建(按钮的位置调节)
	let ulliStr = "<ul style='position:absolute;right:500px;bottom:0;z-index:999;display:flex;justify-content:space-between'>";
	
	for(let i=0;i<this.imgs.length;i++){
		ulliStr +="<li ord='"+(i+1)+"' style='list-style:none;float:left;margin:15px;padding-top:3px;width:"+this.btnWidth+"px;height:"+this.btnHeight+"px;border-radius:50%;text-align:center;background-color:"+this.btnColor+";'>"+(i+1)+"</li>"
	}
	ulliStr +="</ul>";
